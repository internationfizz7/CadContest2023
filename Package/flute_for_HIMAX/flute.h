...
// MODIFY from 2020.03.20//
#define POWVFILE "./input/POWV9.dat"        // LUT for POWV (Wirelength Vector)
#define POSTFILE "./input/POST9.dat"        // LUT for POST (Steiner Tree)
...
typedef struct
{
    ...
    int n;          // index of 'neighbor' branches
}Branch;
