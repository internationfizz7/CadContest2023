...
void IterativeMacroLegalizeFlow(NETLIST & nt)
{
    ...
    WriteDefFile(LG_INFO.MacroClusterSet, "./ans.def", stdXCenter, stdYCenter, def_file, false, nt); ///modify 108.03.26
    if (Congestion_PARA)
        WriteDefFile(LG_INFO.MacroClusterSet, "./output/Result/ans_W_blk.def", stdXCenter, stdYCenter, def_file, true,nt);
...
int iter = 9999;
    ...
    if (Congestion_PARA)
    {
       ...
       //WriteDefFile(LG_INFO.MacroClusterSet, "./output/Result/ans_REF.def", BenchInfo.stdYCenter, BenchInfo.stdXcenter, def_file, false);
        ...
        //(LG_INFO.MacroClusterSet, "./output/Result/ans_REF_BM.def", BenchInfo.stdYCenter, BenchInfo.stdXcenter, def_file, false);
        if (Congestion_PARA)
...
void Update_NET_INFO(vector<Macro*>& MacroClusterSet)
{
    ...
    for (int i = 0; i < (int)MovableMacro_ID.size(); i++)
    {
        ...
        for (int j = 0; j < (int)ori_macro_temp->NetID.size(); j++)
        {
            ...
            Net_ML& net_temp = net_list[net_id];
...
void Evaluate_Placement(Legalization_INFO& LG_INFO)
{
  ...
  /*  cout << AllCornerNode.size() << endl;
    cout << MacroCluster.size() << endl;*/
    ...
    cout << LG_INFO.cost_container.size() << endl;
